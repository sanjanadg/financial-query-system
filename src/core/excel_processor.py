...
Handles structured financial data extraction, multi-company queries, and calculations.
"""
...
class ExcelProcessor:
    ...
    def query_file(self, representation, query):
        ...
        if not representation:
            return {"error": "No representation available", "query": query}
        ...
        if 'financial_data' in representation:
            ...
            if result and result['data_points']:
                result['query'] = query  # Add query to result
        ...
        # No results found
        result = {
            'query': query,  # Add query to result
    ...
    def _search_financial_data(self, query, companies, metrics, time_periods, representation):
        ...
        if result['data_points']:
            ...
            result['data_points'] = result['data_points'][:15]  # Limit to top 10
            return result
    ...
    def _extract_metrics(self, query):
        ...
        metric_patterns = [
            ...
            'shipping income', 'direct labor', 'advertising forecasts' 'insurance', 'advertising',
